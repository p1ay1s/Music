...
import com.niki.utils.base.BaseInterface

/**
 * @param VB databinding
 * @param D dataclass
 * @param C content 后面可能需要的内容
 * @param diffCallback 自行实现 YourCallback: DiffUtil.ItemCallback<YourBean>()
 */
abstract class BaseAdapter<VB : ViewDataBinding, D, C>(
    diffCallback: DiffUtil.ItemCallback<D>
) : ListAdapter<D, BaseAdapter<VB, D, C>.ViewHolder>(diffCallback),
    BaseInterface<VB> {
